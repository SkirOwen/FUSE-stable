...
run_fuse(
	...
	generate_gn_boss_structures=True,
	# if set to true, when FUSE is firt launched, it will run gn-boss to generate the pool of referennce structures for this calculation.
	# TODO: Conda is not in PATH ~ not always recommended
	gn_boss_command=os.system(f"mamba run -n gnboss get_cifs_for_FUSE.py"),
	...
	clear_previous_gn_structures=True,
	...
	r_kwds=['opti conj conp noelectro', 'opti conj conp noelectro', 'opti conp noelectro', 'opti conp noelectro'],
	...
	vasp_opts={
		'1': Vasp(prec='Fast', ediff=1.E-4, nelm=50, encut=600, ibrion=2, isif=3, nsw=100, ediffg=0.05, nwrite=1,
		          ncore=10, algo='Fast', gamma=True, lreal='Auto', setups={'Li': '_sv', 'Sn': '_d'}, kspacing=0.5),
		'2': Vasp(prec='Fast', ediff=1.E-4, nelm=50, encut=600, ibrion=2, isif=3, nsw=100, ediffg=0.05, nwrite=1,
		          ncore=10, algo='Fast', gamma=True, lreal='Auto', setups={'Li': '_sv', 'Sn': '_d'}, kspacing=0.5),
		'3': Vasp(prec='Normal', ediff=1.E-5, nelm=50, encut=650, ibrion=1, isif=3, nsw=20, ediffg=-0.03, nwrite=1,
		          ncore=10, gamma=True, lreal='.False.', setups={'Li': '_sv', 'Sn': '_d'}, kspacing=0.3, ismear=0),
		'4': Vasp(prec='Normal', ediff=1.E-5, nelm=50, encut=650, ibrion=1, isif=3, nsw=20, ediffg=-0.03, nwrite=1,
		          ncore=10, gamma=True, lreal='.False.', setups={'Li': '_sv', 'Sn': '_d'}, kspacing=0.3, ismear=0),
		'5': Vasp(prec='Normal', ediff=1.E-5, nelm=50, encut=650, ibrion=1, isif=3, nsw=150, ediffg=-0.03, nwrite=1,
		          ncore=10, gamma=True, lreal='.False.', setups={'Li': '_sv', 'Sn': '_d'}, kspacing=0.3, ismear=0),
	},
	kcut=[20],
