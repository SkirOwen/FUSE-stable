...
This readme covers FUSE version 1, which is archived here in old_versions/ and is no longer the current version.

Version 2 is the current version - it lives at the root of this repository, with its own readme and install instructions.

********************************************************************************
There were three stable versions of FUSE v1, each archived here in its own folder (and tagged in git - see the repository's tags and releases):
